<template lang="pug">
  div.info-page
    ...
    blockquote.frame.brand(style="font-size:larger").
      #[strong The purpose for Open Platforms is to provide the infrastructure for data mobility and innovation in the gig economy.]
