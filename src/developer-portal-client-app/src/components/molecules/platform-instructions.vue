<template lang="pug">
  .instructions
    ...
    ol
      li
        p You need to build an endpoint that returns the user's data in our specified data format. You can read more about the #[router-link(to="/platform-api-requests") request structure and data format here]
      li
