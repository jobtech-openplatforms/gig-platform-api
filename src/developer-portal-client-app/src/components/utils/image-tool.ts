// https://gist.github.com/dcollien/312bce1270a5f511bf4a also shared on stack overflow
...
export default class ImageTools {
  public static resize(file, maxDimensions, callback) {
  ...
  public static _toBlob(canvas, type) {
